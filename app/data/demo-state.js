window.SHIP_SENTINEL_DEMO_STATE = {
  meta: {
  ...
  intake: {
    ...
    out_of_scope: ["대규모 부하 테스트", "다국어 번역 검수"]
  },
  screens: [
    {
      ...
      references: ["Figma: Login / Default", "PDF: acme-auth-flow p.3"]
    },
    {
      ...
      references: ["Figma: Checkout / Main", "PDF: acme-checkout p.14"],
    ...
    },
    {
      ...
      references: ["Figma: Order Complete", "PDF: acme-checkout p.15"]
    }
  ],
  scenarios: [
    {
  ...
  notes: [
    ...
    },
    {
      ...
      scenario_id: "SCN-002",
      note_type: "qa",
      body: "결제 버튼 위치/상태 불일치",
      linked_evidence_ids: ["EVD-021"],
      promote_to_bug: false,
      promote_to_change_request: true,
      reference_version: "checkout-main-v7",
      geometry: { pane: "reference", x_pct: 0.52, y_pct: 0.18 },
      created_at: "2026-04-01 10:25",
      updated_at: "2026-04-01 10:25"
    },
    {
      note_id: "NOTE-102",
      screen_id: "acme-checkout-014",
      scenario_id: "SCN-002",
      note_type: "qa",
      body: "라이브 캡처 기준 버튼 불일치",
      linked_evidence_ids: ["EVD-021"],
      promote_to_bug: true,
      promote_to_change_request: false,
      reference_version: "checkout-main-v7",
      geometry: { pane: "live", x_pct: 0.55, y_pct: 0.20 },
      created_at: "2026-04-01 10:26",
      updated_at: "2026-04-01 10:26"
    },
    {
      note_id: "NOTE-103",
      screen_id: "acme-checkout-014",
      ...
      note_type: "qa",
      body: "에러 배너 위치 어긋남",
      linked_evidence_ids: ["EVD-002"],
      promote_to_bug: true,
      promote_to_change_request: false,
      reference_version: "checkout-main-v7",
      geometry: { pane: "live", x_pct: 0.83, y_pct: 0.77 },
      created_at: "2026-04-01 10:27",
      updated_at: "2026-04-01 10:27"
    },
    {
      note_id: "NOTE-201",
      screen_id: "acme-auth-001",
      scenario_id: "SCN-001",
      note_type: "qa",
      body: "로그인 입력칸 라벨 문구 상이",
      linked_evidence_ids: ["EVD-001"],
      promote_to_bug: false,
      promote_to_change_request: true,
      reference_version: "login-v2",
      geometry: { pane: "reference", x_pct: 0.12, y_pct: 0.80 },
      created_at: "2026-04-01 09:58",
      updated_at: "2026-04-01 09:58"
    }
  ],
  memo: {
    decision: "수정 후 출시",
